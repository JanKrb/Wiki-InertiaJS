    ...
    <div class="col-span-12 xxl:col-span-10">
      <div class="grid grid-cols-12 gap-5 mt-6 -mb-6">
        ...
        >
          ...
          <div class="w-full p-5 text-gray-700 dark:text-gray-600" v-html="post?.content?.substring(0,200)"></div>{{ post?.content?.length > 200 ? '...' : '' }}
